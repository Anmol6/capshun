...
class CaptioningRNN(object):
  ...
  def loss(self, features, captions):
    ...
    grads['h'], grads['W_vocab'], grads['b_vocab'] = temporal_affine_backward(d_scores, cache4)
    grads['x'],grads['h0'],grads['Wx'], grads['Wh'], grads['b'] = rnn_backward(grads['h'], cache3)
    grads['W_embed'] = word_embedding_backward(grads['x'],  cache2)
    grads['W_proj'] = features.T.dot(grads['h0'])
    grads['b_proj'] = np.sum(grads['h0'], axis=0)
